...
urlpatterns = patterns('',
    url(r'^activate/(?P<activation_code>\w+)$', views.UserActivation.as_view()),
    url(r"^activation-message/$", views.UserActivationMessage.as_view(), name="activation_message"),
    url(r"^activation-successful/$", views.UserActivationSuccessful.as_view(), name="activation_successful"),
    url(r"^complete-data/$", views.UserCompleteData.as_view(), name="complete_data"),
    url(r"^delete/connection/(?P<provider>[\w\-]+)/$", views.UserDeleteConnection.as_view(), name="delete_connection"),
